...
class DestinationSettingVC: UIViewController {
    //MARK: - properties
    private let viewModel: DestinationSettingVM
    ...
    //MARK: - Lifecycle
    init(viewModel: DestinationSettingVM) {
    ...
    private func bindViewModel() {
        ...
        let input = DestinationSettingVM.Input(inputTextField: searchTextField.textField.rx.text.orEmpty.asObservable(),
    ...
    private func hiddenTableViewDependsOnListCount(output: DestinationSettingVM.Output) {
    ...
    private func setupSearchResultTableView(output: DestinationSettingVM.Output) {
        output.searchedLocationLists
    ...
    private func updateTypeButton(output: DestinationSettingVM.Output) {
        output.buttonType
    ...
    private func setupTableViewSelectEvent(output: DestinationSettingVM.Output) {
